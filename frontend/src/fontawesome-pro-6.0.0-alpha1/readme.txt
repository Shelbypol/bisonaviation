...
## Get Started
We've wrapped up the v6 Alpha in a nice little package for you. All you need to do is unwrap it with the following commands:

**Windows**
Run `demo-win.exe` to launch the Font Awesome 6 demo.

**Mac**
Run `demo-macos` to launch the Font Awesome 6 demo.

**Linux**
Run `demo-linux` to launch the Font Awesome 6 demo.
...
| --------------------- | ----------------------------------------------------------------------------------------- |
| `demo-macos`          | Open this to run the documentation on Mac OS X                                            |
| `demo-win.exe`        | Open this to run the documentation on Windows                                             |
| `demo-linux`          | Open this to run the documentation on Linux                                               |
