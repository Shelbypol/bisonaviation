                ...
                <Container className='my-5 bg-transparent px-md-4 px-sm-0'
                    ...
                    <Row className='px-auto d-flex justify-content-center'>
                            ...
                            <TeamCard
                                ...
                                locations={'Boerne Stage Airfield - 5C1'}
                                specialTraining={'GarminAd G500, G600, G1000 Line Maintenance, Raytheon Aircraft Maintenance Professionalism & Resource Management, Rockwell Collins Proline Maintenance'}
                                bio={
