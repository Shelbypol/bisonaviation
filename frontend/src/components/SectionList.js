...
const List = ({link, lg, md, xs, item1, item2, item3, item4, item5, item6, item7, item8, item9, item10, borderLeftTrue}) => {
    ...
    return (
        <Col lg={lg} md={md} xs={xs}
             className=
                 {borderLeftTrue ?
                     'mx-0 py-0 px-2 my-5 global_goldenrod global_black-transparent global_goldenrod-border-left'
                     :
                     'mx-0 py-0 px-2 my-5 global_goldenrod global_black-transparent global_goldenrod-border-right'
             }
        >
