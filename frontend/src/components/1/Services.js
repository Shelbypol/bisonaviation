    ...
    return (
        ...
        <Jumbotron className='m-0 p-0 bg-white Services_NavBg global_silver-chalice-bg d-flex align-content-stretch'
            ...
            {/*<Row xs={12} className=' m-auto'>*/}
                ...
                <Col xs={6} className='border d-flex align-items-center'>
                    <h1 className='global_title'>Services</h1>
                </Col>

                <Row xs={6} className='border d-flex align-items-center align-content-center mx-auto'>
                    <Col xs={12} className='mb-3 Services_nav_hoverTitle'>
