    ...
    return (
        <>
            <Row xs={12} className='d-flex justify-content-center '>
                <Col xs={3} className='d-md right-gradient img-hover-zoom img-hover-zoom--slowmo'>
                    <img src={imgSrc1} alt="" className='rounded h-100 w-100'/>
                </Col>
                <Col xs={3} className='d-none d-md-block img-hover-zoom img-hover-zoom--slowmo'>
                    <img src={imgSrc2} alt="" className='rounded h-100 w-100'/>
                </Col>
                <Col xs={3} className='d-none d-md-block img-hover-zoom img-hover-zoom--slowmo'>
                    <img src={imgSrc3} alt="" className='rounded h-100 w-100'/>
                </Col>
                <Col xs={3} className='left-gradient img-hover-zoom img-hover-zoom--slowmo' >
