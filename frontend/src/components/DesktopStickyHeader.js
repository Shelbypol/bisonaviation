                ...
                <Navbar className='navbar navbar-expand-lg navbar-light bg-light mx-auto my-0 p-0 border-0'>
                    ...
                    <Container className='col-sm-12'>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                                ...
                                <Nav className='col-md-7 stickyNavBtn justify-content-md-end'>
                                    {/*<Nav className='col-md-8 m-0 stickyNavBtn justify-content-center'>*/}
                            ...
                            />}/>
                                ...
                                {/*   PROFILE BTNS  */}
                                <Nav className='col-md-2 justify-content-end'>
